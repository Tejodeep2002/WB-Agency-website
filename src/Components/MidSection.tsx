...
const MidSection = () => {
  return (
    <section className="w-full h-auto">
      <section className="w-full max-w-[90rem] mx-auto mb-[100px] flex">
        <section className="w-full flex justify-between">
          <div className="w-fit p-[30px] pr-10 flex gap-9  text-white">
            <span>
              <svg className="w-[90px] fill-primary ">
          ...
          <div className="w-fit f-full p-[30px] pr-10 flex gap-9 text-white">
            <span className=" ">
              <svg className="w-[115px] fill-primary">
