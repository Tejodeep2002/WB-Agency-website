        ...
        <section className="w-full max-w-[100rem] mx-auto h-auto ">
          <section className="w-full h-fit flex flex-col">
            ...
            >
              ...
              steps.step%2 === 1?
              <SwiperSlide key={steps._key} className="relative w-full flex flex-col pl-0 process-padding-left-0">
               ...
               <SwiperSlide key={steps._key} className="relative w-full flex flex-col pr-20 process-padding-left-0 ">
               <section className="w-full h-[1px] absolute  bg-primary top-1/2 left-0">
                 <span className="relative w-full h-full bg-primary"></span>
               </section>
