...
const Banner = () => {
  ...
  return (
    <section ref={banner} className=" w-full h-auto mt-10">
      <section className=" w-full max-w-[90rem] h-auto mx-auto">
        <section className=" w-full flex flex-wrap justify-evenly xl:justify-between">
          <div className="w-full sm:w-fit">
            <div className="banner1  max-w-[28rem] h-auto p-[25px] mx-auto group flex flex-col sm:flex-row gap-5 sm:gap-6 text-secondary">
              <svg
                className=" w-[110px] h-fit sm:w-[130px] mx-auto fill-primary group-hover:animate-wiggle"
                viewBox="0 0 100 120"
                x="0px"
                y="0px"
              >
              ...
              <div className=" w-fit h-auto text-center sm:text-left flex flex-col gap-3">
                <div className=" text-[26px] sm:text-[30px] leading-[34.8px]  font-semibold text-secondary">
                  Marketing Master
                </div>
                <div className="">
                  <p>
          ...
          <div className=" w-full sm:w-fit">
            <div className=" banner1 max-w-[28rem]  h-auto p-[25px] mx-auto group flex flex-col sm:flex-row gap-5 sm:gap-6  text-white">
              <svg
                className=" w-[110px] h-fit  sm:w-[130px]  mx-auto fill-primary group-hover:animate-wiggle"
                viewBox="9 0 110 126"
                x="0px"
          ...
          <div className=" w-full sm:w-fit">
            <div className=" banner1 max-w-[28rem] h-full p-[25px] mx-auto group flex flex-col sm:flex-row gap-5 sm:gap-6 text-white ">
              <svg
                className=" w-[110px] sm:w-[130px] h-fit  mx-auto fill-primary group-hover:animate-wiggle"
                viewBox="0 0 110 126"
                x="0px"
                y="0px"
              >
              ...
              <div className=" w-fit h-auto text-center sm:text-left flex flex-col gap-3 ">
                <div className="text-[26px] sm:text-[30px] mx-auto leading-[34.8px]  font-semibold text-secondary ">
                  Innovative Design
                </div>
                <div className="">
                  <p>
