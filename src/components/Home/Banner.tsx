...
const Banner = () => {
  ...
  return (
    <section ref={banner} className="w-full h-auto">
      <section className="w-full max-w-[90rem] mx-auto mb-[100px] ">
        <section className="w-full h-full flex flex-col ">
          <div className="w-full lg:mx-auto border">
            <div className="banner1 w-[30rem] h-full lg:p-[30px] lg:pr-10 flex gap-9  text-white border">
              <span>
                <svg
                  className="w-[90px]  fill-primary"
                  viewBox="0 0 100 117"
                  x="0px"
                  y="0px"
                >
              ...
              <div className=" w-fit h-auto flex flex-col gap-3 ">
                <div className="text-[30px] leading-[34.8px]  font-semibold text-left hover:text-primary">
                  Advanced Tools
                </div>
                <div>
          ...
          <div className=" banner1 w-fit h-full p-[30px] pr-10 flex gap-9 text-white">
            <svg
              className="w-[124px]  fill-primary"
              viewBox="0 0 126 110"
              x="0px"
              y="0px"
            >
          ...
          <div className="banner1 w-fit p-[30px] pr-10 flex gap-9  text-white">
            <span>
              <svg
                className="w-[80px] fill-primary"
                viewBox="0 0 100 110"
                x="0px"
                y="0px"
              >
